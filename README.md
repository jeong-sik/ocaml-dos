...
| M4 | 삼국지 III — KOEI.COM 사슬 완주, 카피프로텍션 통과(입력 코드 검증 해독), EMS 데이터 버퍼, 한글 메인 메뉴→시나리오·군주 선택→난이도 설정까지 지나 **게임 본편(184년 1월, 유비 전략 지도)** 진입까지 run.sh 한 방 재현(`--feed-sync`, 62키). 이후 **턴 진행(월 경과+AI 턴), 외교 이벤트(동맹), 전투 재생(관전: 교전 세력·장수 명판·일진 턴·날씨·전술)** 관측. 남은 관문: 플레이어 직접 전투·세이브/로드·통일 | 진행 |
